...
export const getProduct = async (req, res, next) => {
    try {
        ...
        if(!singleProd) return next(new AppError("Product with the ID not found!", 404))
...
export const getSimilarProducts = async (req, res, next) => {
    try {
        ...
        if(!product) return next(new AppError("Product with the ID not found!", 404))
...
export const updateProduct = async (req, res, next) => {
    ...
    try {
        ...
        if(updatedProduct)  {
            ...
            updatedProduct.discountPrice = discountPrice || updatedProduct.discountPrice
            ...
            updatedProduct.isFeatured = isFeatured !== undefined ? isFeatured : updatedProduct.isFeatured
            updatedProduct.isPublished = isPublished !== undefined ? isPublished : updatedProduct.isPublished
